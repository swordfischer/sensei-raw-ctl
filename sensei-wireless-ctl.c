...
#define USB_PRODUCT_STEELSERIES_WIRELESS_BASE 0x137e
#define USB_PRODUCT_STEELSERIES_WIRELESS_WIRED 0x137c
...
main (int argc, char *argv[])
{
	...
	static const int products[] =
	{
		...
		USB_PRODUCT_STEELSERIES_WIRELESS_BASE,
		USB_PRODUCT_STEELSERIES_WIRELESS_WIRED
	};
